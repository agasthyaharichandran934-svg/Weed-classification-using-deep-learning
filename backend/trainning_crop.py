...
# Enable TF1 compatibility mode when running under TF2 so v1 APIs like
# GraphDef, Session, placeholder, etc. are available.
...
# Provide common TF1 symbols on the `tf` module to help this TF1-style
# script run under TF2 with the compatibility mode enabled.
try:
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--image_dir',
        type=str,
        default=r'C:\Users\New\PycharmProjects\Newbackup\weedout\Weedoutapp\static\newdataset_crop\\',
        help='Path to folders of labeled images.'
        )
    parser.add_argument(
        '--output_graph',
        type=str,
        default='dataset_cropslogs/output_graph.pb',
        help='Where to save the trained graph.'
        )
    parser.add_argument(
        '--output_labels',
        type=str,
        default='dataset_cropslogs/output_labels.txt',
        help='Where to save the trained graph\'s labels.'
        )
    parser.add_argument(
        '--summaries_dir',
        type=str,
        default='dataset_cropslogs/retrain_logs',
    ...
    parser.add_argument(
        '--model_dir',
        type=str,
        default='dataset_cropslogs/imagenet',
        help="""\
